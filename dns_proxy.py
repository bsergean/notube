...
"""
    ...
    Only change by bsergean is the drop option at this point.
    Besides it this is just intercept.py
"""
...
class InterceptResolver(BaseResolver):
    ...
    def __init__(self,address,port,ttl,intercept,skip,nxdomain,forward,all_qtypes,timeout=0,drop=None):
        """
...
if __name__ == '__main__':
    ...
    p.add_argument("--drop","-d",action="append",
                    metavar="<drop>",
                    help="Drop requests for those fqdn")
    args = p.parse_args()
